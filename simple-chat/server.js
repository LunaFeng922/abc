...
// listen for connection from particular clients
io.on('connection', (socket) => {
    ...
    io.emit('messageFromServer', msgForAllClients); //send to all clients, so io.emit, not socket.emit, which only send to the client that just sent the message
